    ...
    <div class="faq-content-layout">
      ...
      <article class="faq-article">
        ...
        <div class="faq-rich-content">
          ...
          <img class="faq-article-image faq-article-image-small" src="https://cdn2.douyinggongchang.com/vicastcam-website-media-20260721/images/login/background.png" alt="VicastCam手机端直播界面">

          <h3>第二步：打开VicastCam手机App，进入直播间</h3>
          <p>点击软件中的直播入口进入直播间后，选择合适的背景效果和画面比例。你也可以在直播过程中随时调整画面参数。</p>

          <img class="faq-article-image" src="https://cdn2.douyinggongchang.com/vicastcam-website-media-20260721/images/home/virtual/camera-reflection-frame.png" alt="VicastCam桌面端界面">
