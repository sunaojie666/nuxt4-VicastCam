...
const platformCatalog = [
  { name: '抖音', icon: mediaUrl('/images/platforms/platform-douyin.png') },
  { name: '快手', icon: mediaUrl('/images/platforms/platform-kuaishou.png') },
  { name: '虎牙直播', icon: mediaUrl('/images/platforms/platform-huya.png') },
  { name: '斗鱼', icon: mediaUrl('/images/platforms/platform-douyu.png') },
  { name: '哔哩哔哩直播', icon: mediaUrl('/images/platforms/platform-bilibili.png') },
  { name: '淘宝直播', icon: mediaUrl('/images/platforms/platform-taobao-live.png') },
  { name: '京东直播', icon: mediaUrl('/images/platforms/platform-jd-live.png') },
  { name: '小红书直播', icon: mediaUrl('/images/platforms/platform-xiaohongshu-live.png') },
  { name: '微信视频号', icon: mediaUrl('/images/platforms/platform-wechat-channels.png') },
  { name: '微博直播', icon: mediaUrl('/images/platforms/platform-weibo-live.png') },
  { name: 'YY直播', icon: mediaUrl('/images/platforms/platform-yy-live.png') },
  { name: '花椒直播', icon: mediaUrl('/images/platforms/platform-huajiao.png') },
  { name: '六间房', icon: mediaUrl('/images/platforms/platform-liujianfang.png') },
  { name: '映客直播', icon: mediaUrl('/images/platforms/platform-inke.png') },
  { name: '酷狗直播', icon: mediaUrl('/images/platforms/platform-kugou-live.png') },
  { name: '酷我聚星', icon: mediaUrl('/images/platforms/platform-kuwo-juxing.png') },
  { name: '网易CC直播', icon: mediaUrl('/images/platforms/platform-wangyi-cc.png') },
  { name: 'MOMO直播', icon: mediaUrl('/images/platforms/platform-momo-live.png') },
  { name: 'AcFun直播', icon: mediaUrl('/images/platforms/platform-acfun-live.png') },
  { name: 'Twitch', icon: mediaUrl('/images/platforms/platform-twitch.png') },
  { name: 'YouTube Live', icon: mediaUrl('/images/platforms/platform-youtube-live.png') },
  { name: 'Facebook Live', icon: mediaUrl('/images/platforms/platform-facebook-live.png') },
  { name: 'Instagram Live', icon: mediaUrl('/images/platforms/platform-instagram-live.png') },
  { name: 'TikTok Live', icon: mediaUrl('/images/platforms/platform-tiktok-live.png') },
  { name: 'X', icon: mediaUrl('/images/platforms/platform-x-live.png') },
  { name: 'Kick', icon: mediaUrl('/images/platforms/platform-kick.png') },
  { name: 'Trovo', icon: mediaUrl('/images/platforms/platform-trovo.png') },
  { name: 'BIGO LIVE', icon: mediaUrl('/images/platforms/platform-bigo-live.png') },
  { name: 'Nimo TV', icon: mediaUrl('/images/platforms/platform-nimo-tv.png') },
  { name: 'AfreecaTV', icon: mediaUrl('/images/platforms/platform-afreecatv.png') },
  { name: 'CHZZK', icon: mediaUrl('/images/platforms/platform-chzzk.png') },
  { name: 'Rumble', icon: mediaUrl('/images/platforms/platform-rumble-live.png') },
  { name: 'DLive', icon: mediaUrl('/images/platforms/platform-dlive.png') },
  { name: 'Steam Broadcast', icon: mediaUrl('/images/platforms/platform-steam-broadcast.png') },
  { name: 'LinkedIn Live', icon: mediaUrl('/images/platforms/platform-linkedin-live.png') },
  { name: 'Vimeo Live', icon: mediaUrl('/images/platforms/platform-vimeo-live.png') },
  { name: 'Dacast', icon: mediaUrl('/images/platforms/platform-dacast.png') },
  { name: 'Brightcove', icon: mediaUrl('/images/platforms/platform-brightcove.png') },
  { name: '17LIVE', icon: mediaUrl('/images/platforms/platform-17live.png') },
  { name: 'OPENREC.tv', icon: mediaUrl('/images/platforms/platform-openrec.png') },
  { name: 'SOOP', icon: mediaUrl('/images/platforms/platform-soop.png') },
  { name: 'Arena', icon: mediaUrl('/images/platforms/platform-arena.png') },
  { name: 'Whatnot', icon: mediaUrl('/images/platforms/platform-whatnot.png') },
  { name: 'Shopify Live', icon: mediaUrl('/images/platforms/platform-shopify-live.png') },
  { name: 'Amazon Live', icon: mediaUrl('/images/platforms/platform-amazon-live.png') },
  { name: 'LiveSpace', icon: mediaUrl('/images/platforms/platform-livespace.png') },
  { name: 'Restream', icon: mediaUrl('/images/platforms/platform-restream-live.png') },
  { name: 'StreamYard', icon: mediaUrl('/images/platforms/platform-streamyard.png') },
  { name: 'Bambuser', icon: mediaUrl('/images/platforms/platform-bambuser.png') },
  { name: 'BigMarker', icon: mediaUrl('/images/platforms/platform-bigmarker.png') },
]
