...
const platformCatalog = [
  ...
  { name: '快手', icon: '/images/platforms/platform-kuaishou.png' },
  { name: '虎牙直播', icon: '/images/platforms/platform-huya.png' },
  { name: '斗鱼', icon: '/images/platforms/platform-douyu.png' },
  { name: '哔哩哔哩直播', icon: '/images/platforms/platform-bilibili.png' },
  { name: '淘宝直播', icon: '/images/platforms/platform-taobao-live.png' },
  { name: '京东直播', icon: '/images/platforms/platform-jd-live.png' },
  { name: '小红书直播', icon: '/images/platforms/platform-xiaohongshu-live.png' },
  { name: '微信视频号', icon: '/images/platforms/platform-wechat-channels.png' },
  { name: '微博直播', icon: '/images/platforms/platform-weibo-live.png' },
  { name: 'YY直播', icon: '/images/platforms/platform-yy-live.png' },
  { name: '花椒直播', icon: '/images/platforms/platform-huajiao.png' },
  { name: '六间房', icon: '/images/platforms/platform-liujianfang.png' },
  { name: '映客直播', icon: '/images/platforms/platform-inke.png' },
  { name: '酷狗直播', icon: '/images/platforms/platform-kugou-live.png' },
  { name: '酷我聚星', icon: '/images/platforms/platform-kuwo-juxing.png' },
  { name: '网易CC直播', icon: '/images/platforms/platform-wangyi-cc.png' },
  { name: 'MOMO直播', icon: '/images/platforms/platform-momo-live.png' },
  { name: 'AcFun直播', icon: '/images/platforms/platform-acfun-live.png' },
  { name: 'Twitch', icon: '/images/platforms/platform-twitch.png' },
  { name: 'YouTube Live', icon: '/images/platforms/platform-youtube-live.png' },
  { name: 'Facebook Live', icon: '/images/platforms/platform-facebook-live.png' },
  { name: 'Instagram Live', icon: '/images/platforms/platform-instagram-live.png' },
  { name: 'TikTok Live', icon: '/images/platforms/platform-tiktok-live.png' },
  { name: 'X', icon: '/images/platforms/platform-x-live.png' },
  { name: 'Kick', icon: '/images/platforms/platform-kick.png' },
  { name: 'Trovo', icon: '/images/platforms/platform-trovo.png' },
  { name: 'BIGO LIVE', icon: '/images/platforms/platform-bigo-live.png' },
  { name: 'Nimo TV', icon: '/images/platforms/platform-nimo-tv.png' },
  { name: 'AfreecaTV', icon: '/images/platforms/platform-afreecatv.png' },
  { name: 'CHZZK', icon: '/images/platforms/platform-chzzk.png' },
  { name: 'Rumble', icon: '/images/platforms/platform-rumble-live.png' },
  { name: 'DLive', icon: '/images/platforms/platform-dlive.png' },
  { name: 'Steam Broadcast', icon: '/images/platforms/platform-steam-broadcast.png' },
  { name: 'LinkedIn Live', icon: '/images/platforms/platform-linkedin-live.png' },
  { name: 'Vimeo Live', icon: '/images/platforms/platform-vimeo-live.png' },
  { name: 'Dacast', icon: '/images/platforms/platform-dacast.png' },
  { name: 'Brightcove', icon: '/images/platforms/platform-brightcove.png' },
  { name: '17LIVE', icon: '/images/platforms/platform-17live.png' },
  { name: 'OPENREC.tv', icon: '/images/platforms/platform-openrec.png' },
  { name: 'SOOP', icon: '/images/platforms/platform-soop.png' },
  { name: 'Arena', icon: '/images/platforms/platform-arena.png' },
  { name: 'Whatnot', icon: '/images/platforms/platform-whatnot.png' },
  { name: 'Shopify Live', icon: '/images/platforms/platform-shopify-live.png' },
  { name: 'Amazon Live', icon: '/images/platforms/platform-amazon-live.png' },
  { name: 'LiveSpace', icon: '/images/platforms/platform-livespace.png' },
  { name: 'Restream', icon: '/images/platforms/platform-restream-live.png' },
  { name: 'StreamYard', icon: '/images/platforms/platform-streamyard.png' },
  { name: 'Bambuser', icon: '/images/platforms/platform-bambuser.png' },
  { name: 'BigMarker', icon: '/images/platforms/platform-bigmarker.png' },
]
