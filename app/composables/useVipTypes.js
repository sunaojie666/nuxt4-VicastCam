...
const badgeImages = [
  mediaUrl('/images/profile/month.png'),
  mediaUrl('/images/profile/year.png'),
  mediaUrl('/images/profile/gold.png'),
]
const themes = ['theme-cyan', 'theme-blue', 'theme-violet']
const homePriceImages = {
  '9.99': mediaUrl('/images/pricing/price-9-99.png'),
  '69.99': mediaUrl('/images/pricing/price-69-99.png'),
  '89.99': mediaUrl('/images/pricing/price-99-99.png'),
  '99.99': mediaUrl('/images/pricing/price-99-99.png'),
}
...
const fallbackPlans = [
  {
    ...
    price: '¥9.99',
    priceImage: mediaUrl('/images/pricing/price-9-99.png'),
    originalPrice: '',
    unit: '/月',
    cta: '购买',
    badgeText: '',
  ...
  },
  {
    ...
    price: '¥69.99',
    priceImage: mediaUrl('/images/pricing/price-69-99.png'),
    originalPrice: '',
    unit: '/年',
    cta: '购买',
    badgeText: '最受欢迎',
  ...
  },
  {
    ...
    price: '$89.99',
    priceImage: mediaUrl('/images/pricing/price-99-99.png'),
    originalPrice: '',
    unit: '',
    cta: '购买',
    badgeText: '',
